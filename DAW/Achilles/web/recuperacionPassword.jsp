    ...
    <body class="min-h-screen bg-zinc-800 m-0 p-0">
        ...
        <div
            ...
            <div class="w-full max-w-sm space-y-10">
                ...
                <div class=" flex relative -space-y-px rounded-md shadow-sm ">
                    <div>
                        <label for="nick" class="sr-only">nick</label>
                        <input id="nick" name="nick" required class="pl-1 w-11/12 relative block rounded-md border-0 py-1.5 bg-zinc-700 text-zinc-100 ring-1 ring-inset ring-zinc-500 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-brown-400 sm:text-sm sm:leading-6" placeholder="nick">
                    </div>
                    <button 
                        id="conseguir_preguntas"
                        class="px-4 py-1.5 rounded-md bg-brown-400 w-full text-sm font-semibold text-zinc-100 hover:bg-brown-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brown-500"
                        >
                        Conseguir Preguntas
                    </button>
                </div>
                <form id="formulario" class="space-y-6" action="/Achilles/ControladorLogin/cambiarContrasenia" method="POST">
<!--                    <div class="relative -space-y-px rounded-md shadow-sm">
                        <div
                            class="pointer-events-none absolute inset-0 z-10 rounded-md ring-1 ring-inset ring-zinc-500"
                            ></div>
                        <div
                            class="pl-2 relative block w-full rounded-t-md border-0 py-1.5 bg-zinc-700 text-selective-yellow-500 ring-1 ring-inset ring-zinc-500 sm:text-sm sm:leading-6"
                            >
                            Que desea hacer?
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                name="respuesta_1"
                                required
                                class="pl-2 relative block w-full border-0 py-1.5 bg-zinc-700 text-zinc-100 ring-1 ring-inset ring-zinc-500 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-brown-400 sm:text-sm sm:leading-6"
                                placeholder="Respuesta 1"
                                />
                        </div>
                        <div
                            class="pl-2 relative block w-full border-0 py-1.5 bg-zinc-700 text-selective-yellow-500 ring-1 ring-inset ring-zinc-500 sm:text-sm sm:leading-6"
                            >
                            Que desea hacer?
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                name="respuesta_2"
                                required
                                class="pl-2 relative block w-full rounded-b-md border-0 py-1.5 bg-zinc-700 text-zinc-100 ring-1 ring-inset ring-zinc-500 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-brown-400 sm:text-sm sm:leading-6"
        ...
        <script src="/Achilles/scripts/get_preguntas.js"></script>
    </body>
</html>
