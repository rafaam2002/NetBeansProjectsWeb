...
<html class="bg-zinc-800">
  ...
  <body>
      ...
      >
        <div class="flex justify-between">
          <div class="flex flex-col justify-between pb-4">
            ...
            <div class="text-2xl text-zinc-50">3000€</div>
            <div class="text-sm">Last Week</div>
            <div class="text-sm">+ 5%</div>
          </div>
          <div class="">
            <img
              src="/img/imagenmoneda.png"
              width="140"
    ...
    <!-- Graficas -->
    <script src="/Achilles/WEB-INf/scripts/graficas.js"></script>
    <!-- Dropdown menu -->
    <script src="/Achilles/WEB-INf/scripts/dropdown_menu.js"></script>
    <script src="/Achilles/WEB-INf/scripts/dropdown_menu_movil.js"></script>
  </body>
</html>
