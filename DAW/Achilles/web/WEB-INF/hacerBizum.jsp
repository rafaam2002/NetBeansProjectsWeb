<%-- 
    Document   : hacerbizum
    Created on : 12-dic-2023, 22:23:56
    Author     : rafaa
--%>
                    ...
                    <li class="relative md:flex md:flex-1">
                        ...
                        <a
                            ...
                            <span
                                ...
                                >
                                <span class="text-selective-yellow-500">01</span>
                            </span>
                            <span class="ml-4 text-sm font-medium text-selective-yellow-500"
                                  >Contacto</span
                            >
                        </a>
                    ...
                    <li class="relative md:flex md:flex-1">
                        ...
                        <span class="flex items-center px-6 py-4 text-sm font-medium">
                            <span
                                ...
                                >
                                <span class="text-zinc-300 group-hover:text-zinc-500"
                                      >02</span
                                >
                            </span>
                            <span
                                class="ml-4 text-sm font-medium text-zinc-300 group-hover:text-zinc-500"
                                >Cantidad</span
                            >
                        </span>
                    </li>
...
//                                contacto
                                ...
                                if (contacto.isBizumActive()) {
                                    out.println("        <div class='flex items-center' onclick='bizumAContacto(" + contacto.getId() + ")'>");
                                } else {
                                    out.println("        <div class='flex items-center' onclick='bizumNoDisponible(this)'>");
